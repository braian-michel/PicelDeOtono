...
var pg = {
   ...
   imgGaleria: document.querySelectorAll(".modal_img img"),
   rutaImagen: null,
...
var mg = {
	...
	lightbox: function(img){
		...
		pg.modal.childNodes[0].style.width = "80%";
		pg.modal.childNodes[0].style.height = "80%";
		...
		pg.modal.childNodes[1].style.right ="auto";
		pg.modal.childNodes[1].style.top ="0px";
		pg.modal.childNodes[1].style.color ="#480066";
